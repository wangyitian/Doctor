...
@interface MY_PushStartLiveView ()
//美颜
...
@implementation MY_PushStartLiveView
...
- (UIButton*)closeButton{
    ...
    if(!_closeButton){
        ...
        //位置
        _closeButton.frame = CGRectMake(MY_ScreenWidth - padding * 2, padding, padding, padding);
        
        [_closeButton setImage:[UIImage imageNamed:@"close_preview"] forState:UIControlStateNormal];
        _closeButton.exclusiveTouch = YES;
        __weak __typeof__(self) weakSelf = self;
        [_closeButton addBlockForControlEvents:UIControlEventTouchUpInside block:^(id sender) {
            [MY_Util popAnimationViewController:weakSelf.viewController];
        }];
    }
    return _closeButton;
}
...
- (UIButton*)cameraButton{
    if(!_cameraButton){
        ...
        //位置
        _cameraButton.frame = CGRectMake(MY_ScreenWidth - padding * 4, padding, padding, padding);
...
- (UIButton*)startLiveButton{
    if(!_startLiveButton){
        ...
        //位置
        _startLiveButton.frame = CGRectMake((MY_ScreenWidth - 200) * 0.5, MY_ScreenHeight - 100, 200, 40);
        ...
        [_startLiveButton addBlockForControlEvents:UIControlEventTouchUpInside block:^(id sender) {
            ...
            if(_self.startLiveButton.selected){
                ...
                stream.url = @"rtmp://live.hkstv.hk.lxdns.com:1935/live/wyt";
