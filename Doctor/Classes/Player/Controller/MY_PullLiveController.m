...
@interface MY_PullLiveController ()
...
@implementation MY_PullLiveController
...
- (void)setupBtn {
    ...
    playBtn.frame = CGRectMake(MY_ScreenWidth - 33 - 10, 64 / 2 - 8, 33, 33);
...
//    heartBtn.frame = CGRectMake(36, MY_ScreenHeight - 36 - 10, 36, 36);
...
//    giftBtn.frame = CGRectMake(MY_ScreenWidth - 50, MY_ScreenHeight - 36 - 10, 36, 36);
