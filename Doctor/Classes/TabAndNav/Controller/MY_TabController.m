...
//    [self setupChildViewController:[[MY_LiveController alloc] init] title:@"直播" imageName:@"tab_vedio" selectedImageName:@"tab_vedio_s"];
    [self setupChildViewController:[[MY_PlayerListController alloc] init] title:@"视频" imageName:@"tab_message" selectedImageName:@"tab_message_h"];
